...
function Sidebar() {
  return (
    ...
    ">
      ...
      <div className="p-6 border-b border-cyan-500/15">
        <div className="flex items-center gap-3">
          <div className="
            ...
            text-xl shadow-[0_0_18px_rgba(76,215,246,0.4)]
        ...
        {NAV_ITEMS.map((item) => (
          <NavLink
            ...
            className={({ isActive }) => `
              ...
              ${isActive
                ? 'bg-[#4cd7f6]/15 text-[#4cd7f6] border-cyan-500/40 shadow-[0_0_15px_rgba(76,215,246,0.25)] font-semibold'
                : 'text-[#8ea0b5] border-transparent hover:bg-[#101d3b]/60 hover:text-white hover:border-white/5'
              }
            `}
          >
      ...
      <div className="p-4 border-t border-cyan-500/15 bg-black/20">
        <div className="
          bg-[#0b1428]/90 border border-cyan-500/20 rounded-xl p-3
          flex items-center gap-2.5 shadow-sm
        ">
          <div className="w-2.5 h-2.5 bg-[#4edea3] rounded-full animate-pulse shadow-[0_0_8px_#4edea3]" />
