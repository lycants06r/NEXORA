...
function SentimentPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="liquid-glass-subtle glass-specular-edge border border-cyan-500/25 rounded-2xl p-4 flex items-center justify-between flex-wrap gap-3 text-xs font-mono shadow-[0_10px_30px_rgba(0,0,0,0.3)]">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl liquid-glass border border-cyan-400/30 flex items-center justify-center text-lg shadow-[0_0_12px_rgba(76,215,246,0.2)]">
            🤖
          </div>
          <div>
        ...
        <span className="px-3 py-1 rounded-xl liquid-glass text-[#4cd7f6] border border-cyan-400/40 font-bold shadow-[0_0_10px_rgba(76,215,246,0.25)]">
          CONFIDENCE ACTIVE
        </span>
      </div>
      ...
      <div className="liquid-glass-strong glass-specular-edge border border-cyan-500/25 rounded-2xl p-6 shadow-[0_15px_45px_rgba(0,0,0,0.5)] relative overflow-hidden">
        ...
        <div className="flex items-center justify-between mb-4 relative z-10">
          <h3 className="text-white font-bold text-base tracking-wider uppercase flex items-center gap-2.5">
            <span className="w-2.5 h-2.5 rounded-full bg-[#4cd7f6] shadow-[0_0_10px_#4cd7f6]" />
            🧪 Multi-Emotion Classifier & Linguistic Evaluator
          </h3>
          <span className="text-[11px] font-mono text-[#4cd7f6] px-2.5 py-1 rounded-lg liquid-glass border border-cyan-400/30 font-bold shadow-[0_0_10px_rgba(76,215,246,0.2)]">
            8-CLASS TAXONOMY
          </span>
        </div>
        ...
        <textarea
          ...
          className="
            w-full bg-black/50 border border-cyan-500/30
            text-white placeholder-gray-500 font-mono text-sm rounded-xl
            px-4 py-3 resize-none
            focus:outline-none focus:border-[#4cd7f6] focus:shadow-[0_0_20px_rgba(76,215,246,0.3)]
        ...
        <div className="flex items-center justify-between mt-3 relative z-10">
          ...
          <button
            ...
            className={`
              ...
              transition-all duration-300 hover:scale-102 active:scale-95
              ${analyzing || !inputText.trim()
                ? 'liquid-glass-subtle text-gray-500 cursor-not-allowed border border-white/10'
                : 'bg-gradient-to-r from-[#4cd7f6] to-[#06b6d4] text-black font-black shadow-[0_0_20px_rgba(76,215,246,0.4)] cursor-pointer hover:shadow-[0_0_25px_rgba(76,215,246,0.6)]'
              }
            `}
          >
        ...
        {analysisResult && (
          <div className="
            mt-5 p-5 liquid-glass-subtle rounded-xl
            border border-cyan-500/35 animate-slide-up shadow-inner relative z-10
          ">
            ...
            <div className="space-y-3">
              <div>
                ...
                {/* Score bar */}
                <div className="h-2.5 bg-black/80 rounded-full relative overflow-hidden border border-white/10 shadow-inner">
                  <div
              ...
              {analysisResult.is_sarcastic && (
                <div>
                  ...
                  <div className="h-2 bg-black/80 rounded-full overflow-hidden border border-white/10 shadow-inner">
                    <div
                ...
                <div className="flex flex-wrap gap-2">
                  {Object.entries(analysisResult.emotions)
                    ...
                    .map(([emotion, score]) => (
                      <span
                        key={emotion}
                        className="text-xs font-mono liquid-glass text-[#ddb7ff] border border-purple-500/35
                                   px-2.5 py-1 rounded-lg font-semibold shadow-[0_0_8px_rgba(221,183,255,0.2)]"
                      >
        ...
        <div className="space-y-3">
          {NORMALIZED_RECORDS.filter(r => r.thread_replies && r.thread_replies.length > 0).map(thread => (
            <div
              ...
              className="p-4 liquid-glass-subtle border border-white/10 hover:border-cyan-400/50 rounded-xl transition-all duration-200 cursor-pointer flex items-center justify-between gap-4 group hover:-translate-y-0.5 hover:shadow-[0_10px_25px_rgba(0,0,0,0.5)]"
            >
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2 mb-1.5">
                  ...
                  <span className="text-[9px] font-mono px-2 py-0.5 rounded-lg liquid-glass text-[#4cd7f6] uppercase flex items-center gap-1 border border-cyan-400/25">
                    <PlatformLogo platform={thread.platform} className="w-2.5 h-2.5" colored={true} />
                    {thread.platform}
                  </span>
                  <span className="text-[9px] font-mono px-2 py-0.5 rounded-lg liquid-glass text-[#ddb7ff] uppercase border border-purple-500/25">
                    {thread.emotion}
                  </span>
                </div>
              ...
              <div className="text-right flex items-center gap-2 shrink-0">
                <span className="text-xs font-mono text-[#4cd7f6] font-bold drop-shadow-[0_0_6px_rgba(76,215,246,0.3)]">
                  {thread.thread_replies.length} Replies
                </span>
                <span className="text-[#8ea0b5] group-hover:text-white group-hover:translate-x-1 transition-all">→</span>
              </div>
            </div>
          ))}
        </div>
